...
<nav class="navbar navbar-expand-lg navbar-light bg-light px-3 py-2">
  <a class="pl-3 ml-5 navbar-brand" href="/"><img class="fl" src="/images/logo.svg" style="height:36px;"></img>Villani Lab</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav pl-4">
      <a class="nav-item nav-link active" href="/ircolitis">irColitis <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link active font-weight-bold" href="/ircolitis/app">Cell Clusters</a>
      <a id="link-gene-contrasts" class="nav-item nav-link active" href="/ircolitis/de?gene=IL26">Gene Contrasts</a>
    </div>
  </div>
</nav>
  ...
  function loadGeneAndColor(geneSym, onDone) {
    ...
    state.gene = geneSym
    document.getElementById("link-gene-contrasts").href = `/ircolitis/de?gene=${state.gene}`
